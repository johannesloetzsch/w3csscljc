...
var G__34383 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__34383;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__34384 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__34384,ch);
...
if(("\\" === ch__$1)){
var ch_34385__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_34385__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_34385__$2);
} else {
}
...
var G__34397 = cljs.core.conj_BANG_.call(null,a,form);
a = G__34397;
continue;
}
}
...
var _STAR_read_delim_STAR_34398 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_34398;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__34399 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__34399,(0),null);
var start_column = cljs.core.nth.call(null,vec__34399,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__34405,(0),null);
var start_column = cljs.core.nth.call(null,vec__34405,(1),null);
...
var vec__34408 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__34408,(0),null);
var end_column = cljs.core.nth.call(null,vec__34408,(1),null);
...
var vec__34411 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var vec__34414 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__34414,(0),null);
var end_column = cljs.core.nth.call(null,vec__34414,(1),null);
...
var sb = (function (){var G__34417 = (new goog.string.StringBuffer());
G__34417.append(initch);
...
var G__34419 = (function (){var G__34418 = sb;
G__34418.append(ch);

return G__34418;
})();
var G__34420 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__34419;
ch = G__34420;
continue;
}
...
switch (G__34423) {
case "\\":
var G__34427 = (function (){var G__34424 = sb;
G__34424.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__34424;
})();
var G__34428 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__34427;
ch = G__34428;
continue;
...
break;
default:
var G__34429 = (function (){var G__34425 = sb;
G__34425.append(ch);

return G__34425;
})();
var G__34430 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__34429;
ch = G__34430;
continue;
...
var vec__34431 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__34431,(0),null);
var end_column = cljs.core.nth.call(null,vec__34431,(1),null);
...
var vec__34434 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__34434,(0),null);
var column = cljs.core.nth.call(null,vec__34434,(1),null);
...
var vec__34439 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__34439,(0),null);
var column = cljs.core.nth.call(null,vec__34439,(1),null);
...
var vec__34444 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__34444,(0),null);
var column = cljs.core.nth.call(null,vec__34444,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__34449 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__34449,(0),null);
var start_column = cljs.core.nth.call(null,vec__34449,(1),null);
...
var vec__34452 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__34452,(0),null);
var end_column = cljs.core.nth.call(null,vec__34452,(1),null);
...
var G__34455 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__34455,true,null,opts,pending_forms);
...
var G__34456 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__34456)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__34456)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__34456)){
...
var _STAR_suppress_read_STAR_34457 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_34457;
}});
...
var G__34458 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__34458,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__34458,rdr,first_line);
...
var G__34462 = matched;
var G__34463 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__34462;
finished = G__34463;
continue;
} else {
...
var _STAR_suppress_read_STAR_34464 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_34464;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env34465 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__34466 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__34466,"(");
...
var G__34467 = (i + (1));
var G__34468 = cljs.core.conj_BANG_.call(null,args,(function (){var or__30083__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__30083__auto__)){
return or__30083__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env34465;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__34469 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__34469);
...
var G__34470 = cljs.core.next.call(null,s__$1);
var G__34471 = ret;
s__$1 = G__34470;
r = G__34471;
continue;
...
var G__34472 = cljs.core.next.call(null,s);
var G__34473 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__34472;
key_vals = G__34473;
continue;
} else {
...
var gensym_env34477 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env34477;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__34478 = token;
var G__34478__$1 = (((G__34478 == null))?null:cljs.core.subs.call(null,G__34478,(1)));
var G__34478__$2 = (((G__34478__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__34478__$1));
var G__34478__$3 = (((G__34478__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__34478__$2));
var G__34478__$4 = (((G__34478__$3 == null))?null:cljs.core.symbol.call(null,G__34478__$3));
if((G__34478__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__34478__$4);
}
})():(function (){var G__34479 = token;
var G__34479__$1 = (((G__34479 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__34479));
if((G__34479__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__34479__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e34486){if((e34486 instanceof Error)){
var e = e34486;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__34490,reader){
...
var opts = map__34491__$1;
var eof = cljs.core.get.call(null,map__34491__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1515638885961
