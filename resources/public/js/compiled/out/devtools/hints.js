...
var reader = (function (){var or__30083__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__30083__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__30083__auto__)){
return or__30083__auto__;
} else {
return (128);
...
var file = cljs.core.get.call(null,map__44498__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__44498__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__44498__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e44497){var _e = e44497;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___44500 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___44500)){
var seen_errors_44501 = temp__5455__auto___44500;
if(cljs.core.truth_(seen_errors_44501.has(self))){
} else {
seen_errors_44501.add(self);

var temp__5457__auto___44502 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___44502)){
var sense_44503 = temp__5457__auto___44502;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_44503)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1515638900689
