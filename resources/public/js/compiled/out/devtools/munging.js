...
var o42607 = temp__5455__auto__;
var temp__5455__auto____$1 = (o42607["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o42608 = temp__5455__auto____$1;
return (o42608["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41678__auto__ = f;
return (o__41678__auto__["toString"]).call(o__41678__auto__);
} else {
return "";
}
}catch (e42609){var _ = e42609;
return "";
}});
...
try{var o__41678__auto___42611 = t;
(o__41678__auto___42611["cljs$lang$ctorPrWriter"]).call(o__41678__auto___42611,t,writer);
}catch (e42610){var __42612 = e42610;
}
...
var char_code = (function (){var o__41678__auto__ = (new String(char$));
return (o__41678__auto__["charCodeAt"]).call(o__41678__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41678__auto__ = String;
return (o__41678__auto__["fromCharCode"]).call(o__41678__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42613 = num_code;
switch (G__42613) {
case (1):
return (185);
...
var o__41678__auto__ = String;
return (o__41678__auto__["fromCharCode"]).call(o__41678__auto__,superscript_code);
});
/**
...
}catch (e42615){var _e__41685__auto__ = e42615;
return false;
}})())){
...
var vec__42616 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__42616,(0),null);
...
var or__30083__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
if(cljs.core.truth_(temp__5455__auto__)){
var o42619 = temp__5455__auto__;
var temp__5455__auto____$1 = (o42619["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o42620 = temp__5455__auto____$1;
return (o42620["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31362__auto___42627 = arguments.length;
var i__31363__auto___42628 = (0);
while(true){
if((i__31363__auto___42628 < len__31362__auto___42627)){
args__31369__auto__.push((arguments[i__31363__auto___42628]));

var G__42629 = (i__31363__auto___42628 + (1));
i__31363__auto___42628 = G__42629;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31370__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42623){
var vec__42624 = p__42623;
var ns_detector = cljs.core.nth.call(null,vec__42624,(0),null);
var effective_detector = (function (){var or__30083__auto__ = ns_detector;
if(cljs.core.truth_(or__30083__auto__)){
return or__30083__auto__;
} else {
...
var G__42630 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__42631 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__42630;
remaining_tokens = G__42631;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42621){
var G__42622 = cljs.core.first.call(null,seq42621);
var seq42621__$1 = cljs.core.next.call(null,seq42621);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__42622,seq42621__$1);
});
...
var vec__42635 = cljs.core.split_with.call(null,(function (p1__42634_SHARP_){
return cljs.core.not_EQ_.call(null,p1__42634_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__42635,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__42635,(1),null);
...
var vec__42638 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__42638,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__42638,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__42641 = cljs.core.rest.call(null,remaining_tokens);
var G__42642 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__42641;
name_tokens = G__42642;
continue;
} else {
...
var vec__42645 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__42645,(0),null);
var arity = cljs.core.nth.call(null,vec__42645,(1),null);
var vec__42648 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__42648,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__42648,(1),null);
var vec__42651 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__42651,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__42651,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__42651,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__42651,(3),null);
...
var vec__42657 = result;
var munged_ns = cljs.core.nth.call(null,vec__42657,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__42657,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__42657,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__42657,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__42657,(4),null);
var arity = cljs.core.nth.call(null,vec__42657,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__42661 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__42661,(0),null);
var args = cljs.core.nth.call(null,vec__42661,(1),null);
var vec__42664 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__42664,(0),null);
var name = cljs.core.nth.call(null,vec__42664,(1),null);
...
var G__42667 = (arity + (1));
var G__42668 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42669){
var vec__42670 = p__42669;
var arity = cljs.core.nth.call(null,vec__42670,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__42670,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__30083__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__30083__auto__)){
return or__30083__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__42673_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__42674_SHARP_);
...
var args__31369__auto__ = [];
var len__31362__auto___42681 = arguments.length;
var i__31363__auto___42682 = (0);
while(true){
if((i__31363__auto___42682 < len__31362__auto___42681)){
args__31369__auto__.push((arguments[i__31363__auto___42682]));

var G__42683 = (i__31363__auto___42682 + (1));
i__31363__auto___42682 = G__42683;
continue;
} else {
}
break;
...
var argseq__31370__auto__ = ((((1) < args__31369__auto__.length))?(new cljs.core.IndexedSeq(args__31369__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31370__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42677){
var vec__42678 = p__42677;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__42678,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42675){
var G__42676 = cljs.core.first.call(null,seq42675);
var seq42675__$1 = cljs.core.next.call(null,seq42675);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__42676,seq42675__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__30083__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__30083__auto__)){
return or__30083__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__30071__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__30083__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__30083__auto__)){
return or__30083__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__42686__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__42686__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__42686__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__42686__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42687 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__42687,(0),null);
var fn_name = cljs.core.nth.call(null,vec__42687,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__42687,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__42687,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__42687,(4),null);
var arity = cljs.core.nth.call(null,vec__42687,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__30071__auto__ = protocol_ns;
if(cljs.core.truth_(and__30071__auto__)){
return cljs.core.not.call(null,(function (){var and__30071__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__30083__auto__ = protocol_part;
if(cljs.core.truth_(or__30083__auto__)){
return or__30083__auto__;
} else {
return fn_part;
...
var o__41678__auto__ = f;
return (o__41678__auto__["getBasis"]).call(o__41678__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__30071__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__30071__auto__)){
...
}catch (e42691){var _e__41685__auto__ = e42691;
...
var G__42692 = (obj[cljs.core.first.call(null,path)]);
var G__42693 = cljs.core.rest.call(null,path);
obj = G__42692;
path = G__42693;
continue;
} else {
...
var partition_bits = (function (){var or__30083__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__30083__auto__)){
return or__30083__auto__;
} else {
return (0);
...
return (function (accum,p__42694){
var vec__42695 = p__42694;
var bit = cljs.core.nth.call(null,vec__42695,(0),null);
var protocol = cljs.core.nth.call(null,vec__42695,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42698){
var vec__42699 = p__42698;
var ns = cljs.core.nth.call(null,vec__42699,(0),null);
var name = cljs.core.nth.call(null,vec__42699,(1),null);
var selector = cljs.core.nth.call(null,vec__42699,(2),null);
...
return (function (p__42703){
var vec__42704 = p__42703;
var munged_name = cljs.core.nth.call(null,vec__42704,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__42704,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__42704,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__42702_SHARP_){
return (obj[cljs.core.first.call(null,p1__42702_SHARP_)]);
});})(name,sorted_matches,vec__42704,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1515638896448
