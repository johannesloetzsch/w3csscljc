...
var len__31362__auto___42729 = arguments.length;
var i__31363__auto___42730 = (0);
while(true){
if((i__31363__auto___42730 < len__31362__auto___42729)){
args__31369__auto__.push((arguments[i__31363__auto___42730]));

var G__42731 = (i__31363__auto___42730 + (1));
i__31363__auto___42730 = G__42731;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31370__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq42727){
var G__42728 = cljs.core.first.call(null,seq42727);
var seq42727__$1 = cljs.core.next.call(null,seq42727);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__42728,seq42727__$1);
});
...
return (p1__42732_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1515638896596
