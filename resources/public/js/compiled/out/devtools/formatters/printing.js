...
var len__31362__auto___42738 = arguments.length;
var i__31363__auto___42739 = (0);
while(true){
if((i__31363__auto___42739 < len__31362__auto___42738)){
args__31369__auto__.push((arguments[i__31363__auto___42739]));

var G__42740 = (i__31363__auto___42739 + (1));
i__31363__auto___42739 = G__42740;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__31370__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42735){
var G__42736 = cljs.core.first.call(null,seq42735);
var seq42735__$1 = cljs.core.next.call(null,seq42735);
var G__42737 = cljs.core.first.call(null,seq42735__$1);
var seq42735__$2 = cljs.core.next.call(null,seq42735__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__42736,G__42737,seq42735__$2);
});
...
if(cljs.core.truth_((function (){var or__30083__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__30754__auto__,writer__30755__auto__,opt__30756__auto__){
return cljs.core._write.call(null,writer__30755__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__30071__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__30071__auto__){
var or__30083__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__30083__auto__)){
return or__30083__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42741_SHARP_){
return !((cljs.core.meta.call(null,p1__42741_SHARP_) == null));
})))){
...
var map__42742 = opts;
var map__42742__$1 = ((((!((map__42742 == null)))?((((map__42742.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42742.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__42742):map__42742);
var markup_db = cljs.core.get.call(null,map__42742__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__30083__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e42746){var _e__41685__auto__ = e42746;
return false;
}})();
if(cljs.core.truth_(or__30083__auto__)){
return or__30083__auto__;
...
}catch (e42748){var _e__41685__auto__ = e42748;
return false;
}}
})())){
...
var _STAR_current_state_STAR_42750 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__42751 = opts;
var map__42751__$1 = ((((!((map__42751 == null)))?((((map__42751.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42751.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__42751):map__42751);
var markup_db = cljs.core.get.call(null,map__42751__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_42750;
}});
...
;
var temp__5455__auto___42755 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___42755)){
var managed_print_level_42756 = temp__5455__auto___42755;
var _STAR_print_level_STAR_42754_42757 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_42756;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_42754_42757,managed_print_level_42756,temp__5455__auto___42755,writer,opts,job_fn){
return (function (p1__42753_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__42753_SHARP_,null);
});})(_STAR_print_level_STAR_42754_42757,managed_print_level_42756,temp__5455__auto___42755,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_42754_42757;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1515638896695
