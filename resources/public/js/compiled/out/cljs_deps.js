...
goog.addDependency("../w3csscljc/features/debug/core.js", ['w3csscljc.features.debug.core'], ['hiccups.runtime', 'cljs.core', 'domina']);
goog.addDependency("../w3csscljc/features/debug/simple.js", ['w3csscljc.features.debug.simple'], ['cljs.core', 'w3csscljc.features.debug.core']);
goog.addDependency("../w3csscljc/features/debug/example.js", ['w3csscljc.features.debug.example'], ['cljs.core', 'w3csscljc.features.debug.simple', 'w3csscljc.features.debug.core']);
goog.addDependency("../w3csscljc/features/tabs/core.js", ['w3csscljc.features.tabs.core'], ['cljs.core', 'domina']);
goog.addDependency("../w3csscljc/features/tabs/simple.js", ['w3csscljc.features.tabs.simple'], ['w3csscljc.features.tabs.core', 'cljs.core']);
goog.addDependency("../w3csscljc/features/tabs/example.js", ['w3csscljc.features.tabs.example'], ['cljs.core', 'w3csscljc.features.tabs.simple']);
...
goog.addDependency("../w3csscljc/features/ajax_PLUS_markdown/core.js", ['w3csscljc.features.ajax_PLUS_markdown.core'], ['ajax.core', 'markdown.core', 'hiccups.runtime', 'cljs.core', 'domina']);
goog.addDependency("../w3csscljc/example.js", ['w3csscljc.example'], ['domina.css', 'hiccups.runtime', 'cljs.core', 'domina', 'w3csscljc.features.debug.example', 'w3csscljc.features.tabs.example', 'w3csscljc.features.ajax_PLUS_markdown.core', 'w3csscljc.features.tabs.simple']);
...
goog.addDependency("../figwheel/connect/build_dev.js", ['figwheel.connect.build_dev'], ['w3csscljc.example', 'cljs.core', 'figwheel.client', 'figwheel.client.utils']);
