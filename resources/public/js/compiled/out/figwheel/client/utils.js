...
return (new CustomEvent(event_name,(function (){var obj39345 = {"detail":data};
return obj39345;
})()));
} else {
...
var f = (function (){var pred__39352 = cljs.core._EQ_;
var expr__39353 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__39352.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__39353))){
return ((function (pred__39352,expr__39353){
return (function (p1__39346_SHARP_){
return console.warn(p1__39346_SHARP_);
});
;})(pred__39352,expr__39353))
} else {
if(cljs.core.truth_(pred__39352.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__39353))){
return ((function (pred__39352,expr__39353){
return (function (p1__39347_SHARP_){
return console.debug(p1__39347_SHARP_);
});
;})(pred__39352,expr__39353))
} else {
if(cljs.core.truth_(pred__39352.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__39353))){
return ((function (pred__39352,expr__39353){
return (function (p1__39348_SHARP_){
return console.error(p1__39348_SHARP_);
});
;})(pred__39352,expr__39353))
} else {
return ((function (pred__39352,expr__39353){
return (function (p1__39349_SHARP_){
return console.log(p1__39349_SHARP_);
});
;})(pred__39352,expr__39353))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__39356){
var map__39357 = p__39356;
var map__39357__$1 = ((((!((map__39357 == null)))?((((map__39357.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__39357.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39357):map__39357);
var opts = map__39357__$1;
var eval_fn = cljs.core.get.call(null,map__39357__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__39359_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__39361,(0),null);
var v = cljs.core.nth.call(null,vec__39361,(1),null);
...
}catch (e39366){if((e39366 instanceof Error)){
var e = e39366;
return not_found;
} else {
throw e39366;
...
//# sourceMappingURL=utils.js.map?rel=1515638891742
