...
var len__31362__auto___34004 = arguments.length;
var i__31363__auto___34005 = (0);
while(true){
if((i__31363__auto___34005 < len__31362__auto___34004)){
args__31369__auto__.push((arguments[i__31363__auto___34005]));

var G__34006 = (i__31363__auto___34005 + (1));
i__31363__auto___34005 = G__34006;
continue;
} else {
}
break;
...
return markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(argseq__31370__auto__);
});
...
markdown.common.freeze_string.cljs$lang$applyTo = (function (seq34003){
return markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq34003));
});
...
var G__34009 = cljs.core.reduce.call(null,((function (text,state,matches,temp__5455__auto__){
return (function (s,r){
...
return cljs.core.get.call(null,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__34007_SHARP_,p1__34007_SHARP_);
});})(text,state,matches,temp__5455__auto__))
);
});})(text,state,matches,temp__5455__auto__))
,text,matches);
var G__34010 = cljs.core.update.call(null,state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__5455__auto__){
return (function (p1__34008_SHARP_){
return cljs.core.apply.call(null,cljs.core.dissoc,p1__34008_SHARP_,matches);
});})(text,state,matches,temp__5455__auto__))
);
text = G__34009;
state = G__34010;
...
var vec__34013 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__34016 = transformer.call(null,clojure.string.join.call(null,buf),cur_state);
var s = cljs.core.nth.call(null,vec__34016,(0),null);
var new_state = cljs.core.nth.call(null,vec__34016,(1),null);
...
var new_buf = cljs.core.nth.call(null,vec__34013,(0),null);
var new_state = cljs.core.nth.call(null,vec__34013,(1),null);
var G__34020 = cljs.core.vec.call(null,cljs.core.concat.call(null,out,cljs.core.seq.call(null,open),new_buf,cljs.core.seq.call(null,close)));
var G__34021 = cljs.core.PersistentVector.EMPTY;
var G__34022 = cljs.core.rest.call(null,tokens);
var G__34023 = cljs.core.assoc.call(null,new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__34020;
buf = G__34021;
tokens = G__34022;
cur_state = G__34023;
...
var G__34024 = out;
var G__34025 = cljs.core.into.call(null,buf,cljs.core.first.call(null,tokens));
var G__34026 = cljs.core.rest.call(null,tokens);
var G__34027 = cur_state;
out = G__34024;
buf = G__34025;
tokens = G__34026;
cur_state = G__34027;
...
var G__34028 = out;
var G__34029 = buf;
var G__34030 = cljs.core.rest.call(null,tokens);
var G__34031 = cljs.core.assoc.call(null,cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__34028;
buf = G__34029;
tokens = G__34030;
cur_state = G__34031;
...
var G__34032 = cljs.core.into.call(null,out,cljs.core.first.call(null,tokens));
var G__34033 = buf;
var G__34034 = cljs.core.rest.call(null,tokens);
var G__34035 = cur_state;
out = G__34032;
buf = G__34033;
tokens = G__34034;
cur_state = G__34035;
...
var num_hashes = cljs.core.count.call(null,cljs.core.filter.call(null,(function (p1__34036_SHARP_){
return cljs.core.not_EQ_.call(null," ",p1__34036_SHARP_);
}),cljs.core.take_while.call(null,(function (p1__34037_SHARP_){
return (cljs.core._EQ_.call(null,"#",p1__34037_SHARP_)) || (cljs.core._EQ_.call(null," ",p1__34037_SHARP_));
...
//# sourceMappingURL=common.js.map?rel=1515638884883
