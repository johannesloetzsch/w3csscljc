...
return clojure.string.join.call(null,(function (){var iter__30965__auto__ = (function markdown$lists$close_lists_$_iter__34151(s__34152){
return (new cljs.core.LazySeq(null,(function (){
var s__34152__$1 = s__34152;
while(true){
var temp__5457__auto__ = cljs.core.seq.call(null,s__34152__$1);
if(temp__5457__auto__){
var s__34152__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__34152__$2)){
var c__30963__auto__ = cljs.core.chunk_first.call(null,s__34152__$2);
var size__30964__auto__ = cljs.core.count.call(null,c__30963__auto__);
var b__34154 = cljs.core.chunk_buffer.call(null,size__30964__auto__);
if((function (){var i__34153 = (0);
while(true){
if((i__34153 < size__30964__auto__)){
var vec__34155 = cljs.core._nth.call(null,c__30963__auto__,i__34153);
var list_type = cljs.core.nth.call(null,vec__34155,(0),null);
cljs.core.chunk_append.call(null,b__34154,["</li></",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,list_type)),">"].join(''));

var G__34161 = (i__34153 + (1));
i__34153 = G__34161;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__34154),markdown$lists$close_lists_$_iter__34151.call(null,cljs.core.chunk_rest.call(null,s__34152__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__34154),null);
}
} else {
var vec__34158 = cljs.core.first.call(null,s__34152__$2);
var list_type = cljs.core.nth.call(null,vec__34158,(0),null);
return cljs.core.cons.call(null,["</li></",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,list_type)),">"].join(''),markdown$lists$close_lists_$_iter__34151.call(null,cljs.core.rest.call(null,s__34152__$2)));
}
} else {
return null;
}
...
return iter__30965__auto__.call(null,lists);
})());
});
...
var lists_to_close = cljs.core.take_while.call(null,(function (p1__34162_SHARP_){
return (cljs.core.second.call(null,p1__34162_SHARP_) > num_indents);
...
var vec__34163 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__34163,(0),null);
var indents = cljs.core.nth.call(null,vec__34163,(1),null);
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ul","ul",-1349521403),list_type,num_indents,indents,(function (){var or__30083__auto__ = markdown.common.make_heading.call(null,content,false);
...
var vec__34166 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__34166,(0),null);
var indents = cljs.core.nth.call(null,vec__34166,(1),null);
var num_indents = cljs.core.count.call(null,cljs.core.take_while.call(null,cljs.core.partial.call(null,cljs.core._EQ_," "),text));
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ol","ol",932524051),list_type,num_indents,indents,(function (){var or__30083__auto__ = markdown.common.make_heading.call(null,content,false);
if(cljs.core.truth_(or__30083__auto__)){
return or__30083__auto__;
} else {
return content;
...
markdown.lists.li = (function markdown$lists$li(text,p__34169){
...
var state = map__34170__$1;
var codeblock = cljs.core.get.call(null,map__34170__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.call(null,map__34170__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.call(null,map__34170__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.call(null,map__34170__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
if(cljs.core.truth_((function (){var and__30071__auto__ = last_line_empty_QMARK_;
...
var and__30071__auto____$1 = lists;
...
if(cljs.core.truth_((function (){var and__30071__auto__ = (function (){var or__30083__auto__ = eof;
if(cljs.core.truth_(or__30083__auto__)){
return or__30083__auto__;
} else {
...
//# sourceMappingURL=lists.js.map?rel=1515638885145
